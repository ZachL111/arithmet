...
arithmet is a OCaml project for compilers. It focuses on this technical goal: Compile arithmetic expressions to stack bytecode and evaluate golden fixtures.
