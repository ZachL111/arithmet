"""Regression checks for the arithmet casebook."""
...
from casebook.harness import assert_expected, arithmet_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(arithmet_summary(), assert_expected())
